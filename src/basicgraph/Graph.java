...
public abstract class Graph {
	...
	public static void main (String[] args) {
		...
		System.out.println("****");
		List<Integer> degreeSeq = graphFromFile.degreeSequence();
		System.out.println("Degree Sequence: " + degreeSeq);
		System.out.println("\n****");
		...
		List<Integer> distance2List = graphFromFile.getDistance2(4);
		List<Integer> distance2Matrix = graphFromFile2.getDistance2(4);
		System.out.println("List-get distance 2 : " + distance2List);
		System.out.println("Matrix-get distance 2 : " + distance2Matrix);
